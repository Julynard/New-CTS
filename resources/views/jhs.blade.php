...
<body>
    ...
    <div class="container">
        ...
        <small class="text-danger"><b>Location: Junior High School Building</b></small>
        <form action="{{ route('jhs') }}" method="post">
            @csrf
            <input type="hidden" name="txtLocation" value="jhs_bldg">
