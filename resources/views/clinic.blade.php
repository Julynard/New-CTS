...
<body>
    ...
    <div class="container">
        ...
        <small class="text-danger"><b>Location: University Clinic</b></small>
        <form action="{{ route('clinic') }}" method="post">
            @csrf
            <input type="hidden" name="txtLocation" value="university_clinic">
