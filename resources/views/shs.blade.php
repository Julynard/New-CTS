...
<body>
    ...
    <div class="container">
        ...
        <small class="text-danger"><b>Location: Senior High School Building</b></small>
        <form action="{{ route('shs') }}" method="post">
            @csrf
            <input type="hidden" name="txtLocation" value="shs_bldg">
